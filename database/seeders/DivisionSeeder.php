...
class DivisionSeeder extends Seeder
{
    ...
    {
        Division::create([
            'name' => 'Pengembangan Teknologi Informasi (PTI)',
        ...
        Division::create([
            'name' => 'Pengembangan Ilmu Pengetahuan (PIP)',
        ...
        Division::create([
            'name' => 'Politik Propaganda (POLPRO)',
